...
__Understanding the Statistics:__
   1. Given any user condition (say, >, < <=, >=, ==, etc) and a threshold value (say, 15), for each sensor point, count the number of rows satisfy the condition, and output it as a hashmap with Key= sensorPoint and value=numberOfRowsSatisfiyingTheCondition.
...
__Coding tips:__
    ...
    3. Distribute among yourselves properly, and mention the tasks that will be carried out by each student.
